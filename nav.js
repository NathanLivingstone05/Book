  ...
  nav.innerHTML = `
    <div class="nav-inner">
      ...
      <ul class="nav-links" id="navLinks">
        ...
        <li><a href="formation.html" class="${activePage === 'formation' ? 'active' : ''}">Formation</a></li>
  ...
  footer.innerHTML = `
    <div class="footer-inner">
      ...
      <ul class="footer-links">
        ...
        <li><a href="https://www.linkedin.com/in/nathan-livingstone-0997a12a3" target="_blank" rel="noopener">LinkedIn</a></li>
      </ul>
    </div>
  `;
